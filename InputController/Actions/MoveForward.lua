-- MODULESCRIPT: MoveForward
-- Original Path: game.BAC - 21977.Controllers.InputController.Actions.MoveForward
            ...
            if v6 then
                ...
                if v8 then
                    if v8.UpdateMovement then
                        v8.forwardValue = p4 == Enum.UserInputState.Begin and -1 or 0
