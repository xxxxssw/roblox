-- MODULESCRIPT: MoveLeftStrafe
-- Original Path: game.BAC - 21977.Controllers.InputController.Actions.MoveLeftStrafe
            ...
            if v6 then
                ...
                if v8 then
                    if v8.UpdateMovement then
                        v8.leftValue = p4 == Enum.UserInputState.Begin and -1 or 0
