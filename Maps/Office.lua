-- MODULESCRIPT: Office
-- Original Path: game.BAC - 48473.Database.Custom.GameStats.Maps.Office
...
local v3 = {
    ["Icon"] = "rbxassetid://125815127969334",
    ["Gamemode"] = {
        ["Competitive"] = "Hostage Rescue",
        ["Deathmatch"] = "Deathmatch",
        ["Casual"] = "Hostage Rescue"
    },
    ["Characters"] = {
    ...
    ["Lighting"] = {
        ...
        ["Assets"] = v1.Assets.Lighting.Office
    }
}
local v4 = {
    ["Position"] = Vector3.new(68, 90, 1224),
