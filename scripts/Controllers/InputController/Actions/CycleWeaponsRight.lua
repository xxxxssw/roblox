-- MODULESCRIPT: CycleWeaponsRight
-- Original Path: game.BAC - 44074.Controllers.InputController.Actions.CycleWeaponsRight
...
local v_u_4 = require(v1.Components.Common.UserInput.EquipSlotRight)
