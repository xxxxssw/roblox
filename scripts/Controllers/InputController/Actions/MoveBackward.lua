-- MODULESCRIPT: MoveBackward
-- Original Path: game.BAC - 21977.Controllers.InputController.Actions.MoveBackward
            ...
            if v6 then
                ...
                if v8 then
                    if v8.UpdateMovement then
                        v8.backwardValue = p4 == Enum.UserInputState.Begin and 1 or 0
