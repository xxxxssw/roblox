-- MODULESCRIPT: VertigoCrane
-- Original Path: game.BAC - 12574.Controllers.Observers.Game.VertigoCrane
...
v_u_3.AnimationId = "rbxassetid://75914758947993"
v_u_3.Name = "CRANE_IDLE"
return v2.observeTag("VertigoCrane", function(p4)
    -- upvalues: (copy) v_u_3
