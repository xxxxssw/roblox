-- MODULESCRIPT: VertigoGenerator
-- Original Path: game.BAC - 41394.Controllers.Observers.Game.VertigoGenerator
...
v_u_3.AnimationId = "rbxassetid://106431666932790"
v_u_3.Name = "GENERATOR_IDLE"
return v2.observeTag("VertigoGenerator", function(p4)
    -- upvalues: (copy) v_u_3
