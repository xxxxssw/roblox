-- MODULESCRIPT: Winter Mirage
-- Original Path: game.BAC - 14794.Database.Custom.GameStats.Maps.Winter Mirage
...
local v3 = {
    ["Icon"] = "rbxassetid://96281385153177",
    ["Gamemode"] = {
    ...
    ["Lighting"] = {
        ...
        ["Assets"] = v1.Assets.Lighting["Winter Mirage"]
    }
}
local v4 = {
