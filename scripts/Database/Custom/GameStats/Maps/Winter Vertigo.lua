-- MODULESCRIPT: Winter Vertigo
-- Original Path: game.BAC - 14794.Database.Custom.GameStats.Maps.Winter Vertigo
...
local v3 = {
    ["Icon"] = "rbxassetid://98691626384568",
    ["Gamemode"] = {
    ...
    ["Lighting"] = {
        ...
        ["Assets"] = v1.Assets.Lighting["Winter Vertigo"]
    }
}
local v4 = {
